...
The `hihai` package provides clean datasets and interactive Shiny app to explore, visualise, and interpret the burden of HAIs in Germany using the data from **2011 ECDC Point Prevalence Survey** covering 46 German hospitals and 9,626 patients.

## About the data

The package uses two cleaned datasets:
1. `hai_data`: German PPS (five HAI types + total) with 95% uncertainty interval (UI).
2. `hai_comparison`: Germany vs EU/EEA rates using ECDC PPS (29 EU/EEA countries + Croatia) with 95% uncertainty interval (UI).
